            ...
            <div className="modal-dialog d-flex content-center rounded-full items-center w-3/4 relative  pointer-events-none">
                <div className="modal-content border-none shadow-lg relative flex flex-col w-full pointer-events-auto bg-blue-800 bg-clip-padding rounded-md outline-none text-current">
                    <div className="modal-header flex flex-shrink-0 items-center justify-between p-4  rounded-xl">
                        <h5 className="text-3xl font-medium leading-normal text-white mx-2">Confirm Transation</h5>
                        <button
                            type="button"
                            className="btn-close box-content w-5 h-5 p-1 text-2xl text-white border-none rounded-none opacity-50 focus:shadow-none focus:outline-none focus:opacity-100 hover:text-white hover:opacity-75 hover:no-underline" data-bs-dismiss="modal"
                            aria-label="Close">
                            <ImSpinner10 />
                        </button>
                    </div>
