...
const DashcardLg = ({id,name,src,totalDeposit,totalBorrowed,countdown,interest}) => {
    return (
        <div className="container hidden md:block w-auto lg:max-w-1/2 m-5 p-5 mx-auto rounded-xl bg-blue-700">
            ...
            <div className="container flex bg-blue-600 rounded-xl  items-center justify-between p-5">
                ...
                {/* <Image className="rounded-t-lg "  src={src}  layout="responsive" width={800} height={650}  alt={name} loader={myLoader}/> */}
                </div>
                <div className="p-5 text-white">
                    <h1>{name}</h1>
                </div>
                ...
                <button type="button" className="inline-block px-6 py-2.5 text-xl font-semibold text-blue-900 rounded leading-tight bg-yellow-100">
                    Repay
                </button>
            </div>
        </div>
